 ...
 * @date 2009/10/17
 */
public class ExcatConfirmDialog extends Dialog{
	...
	public ExcatConfirmDialog(Shell parentShell, String message) {
		super(parentShell);
	...
	private void createLowerPart(Composite composite){
		...
		GridLayout buttonFormlayout = new GridLayout(2,false);
		buttonForm.setLayout(buttonFormlayout);
		GridData gd = new GridData(GridData.HORIZONTAL_ALIGN_END);
		buttonForm.setLayoutData(gd);

		Button okBtn = Utility.createButton(buttonForm, SWT.PUSH,
		...
		Button noBtn = Utility.createButton(buttonForm, SWT.PUSH,
