...
public class ExcatConfrim3BtnDialog extends Dialog{
	...
	public ExcatConfrim3BtnDialog(Shell parentShell, String message) {
		super(parentShell);
	...
	protected Control createContents(Composite parent) {
		getShell().setText(
				ApplicationResource.getResource("Dialog.Confirm.Title"));
	...
	private void createLowerPart(Composite composite){
		...
		GridLayout buttonFormlayout = new GridLayout(3,false);
		buttonForm.setLayout(buttonFormlayout);
		GridData gd = new GridData(GridData.HORIZONTAL_ALIGN_END);
		buttonForm.setLayoutData(gd);

		yesBtn = Utility.createButton(buttonForm, SWT.PUSH,
				ApplicationResource.getResource("Dialog.Confirm.YES"),
		...
		noBtn = Utility.createButton(buttonForm, SWT.PUSH,
				ApplicationResource.getResource("Dialog.Confirm.NO"),
				Utility.BUTTON_WIDTH,1);
		...
		cancelBtn = Utility.createButton(buttonForm, SWT.PUSH,
				ApplicationResource.getResource("Dialog.Confirm.Cancel"),
				Utility.BUTTON_WIDTH,1);
